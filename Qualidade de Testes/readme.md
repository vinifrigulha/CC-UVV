...
Este documento descreve os requisitos a testar, os  tipos de testes definidos para cada iteração e os recursos de hardware e software a serem empregados. As seções referentes aos requisitos e recursos e cronograma servem para permitir ao gerente do projeto acompanhar a evolução dos testes.
...
### 3.1 - Quantidade de Itens no Carrinho de Compra
